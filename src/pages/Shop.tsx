    ...
    <div className="bg-white text-slate-900">
      ...
      <section className="relative -mt-[76px] flex min-h-[80vh] items-center pt-[100px] text-white">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-6xl px-6 md:px-8">
          <div className="max-w-xl">
            <div className="inline-block rounded-full border border-white/40 bg-black/20 px-4 py-2 text-xs font-semibold uppercase tracking-wide backdrop-blur">
              Luxury Fragrances
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button className="inline-flex items-center justify-center rounded-lg bg-[#d9a93b] px-6 py-3 text-sm font-semibold text-white shadow-md transition hover:bg-[#c8892f] hover:shadow-lg active:scale-95">
                Explore Collection
              </button>
              <button className="inline-flex items-center justify-center rounded-lg border border-white/40 bg-transparent px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10 hover:border-white">
                View Best Sellers
              </button>
            </div>
          </div>
      ...
      >
        ...
        <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
                ...
                <button
                  ...
                  className={`whitespace-nowrap rounded-full border px-4 py-2 text-xs font-semibold transition ${
                    activeFilter === filter
                      ...
                      : "border-slate-200 bg-white text-slate-500 hover:border-slate-900/60 hover:text-slate-900"
                  }`}
                >
                  {filter}
                </button>
          ...
          <div className="ml-auto text-sm text-slate-500 max-sm:hidden">
              ...
              <div className="px-3 pb-4 pt-4">
                <div className="mb-2 flex flex-wrap gap-1">
                  {product.tags.map((tag) => (
                    <span
                      key={tag}
                      className="inline-block rounded bg-slate-100 px-2 py-1 text-[11px] font-semibold text-slate-600"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <h3 className="font-['Playfair_Display'] text-lg text-slate-900">
                  {product.title}
                </h3>

                <p className="mt-2 line-clamp-2 font-['Inter'] text-sm leading-relaxed text-slate-500">
                  {product.description}
                </p>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-sm font-semibold text-[#c8892f] hover:underline"
                  >
                    Details &rarr;
                  </button>
                </div>
